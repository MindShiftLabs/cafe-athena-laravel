...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $image_path = 'assets/images/cafe-atina-logo-nobg.png'; // Default image
  ...
  if (!isset($_SESSION['error_message'])) {
    $stmt = $conn->prepare("INSERT INTO product (product_name, product_description, product_price, product_image, product_status, product_category) VALUES (?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("ssdsss", $name, $description, $price, $image_path, $status, $category);
